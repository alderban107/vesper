...
> A living requirements document for Vesper's end-to-end encryption. Each requirement
> is annotated with its current implementation status. These annotations serve as a
> guide for what exists, what's partially done, and what must not be removed because
> it satisfies a specific security or correctness requirement.
>
> Read this alongside [E2EE-IMPLEMENTATION.md](./E2EE-IMPLEMENTATION.md) (how the
> system works today) and [DESIGN.md](./DESIGN.md) (the overall architecture).
>
> **Status key:**
