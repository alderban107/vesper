...
The SDK ships with a bot framework in the examples directory (`sdk/examples/bot-framework.mjs`). It handles authentication, MLS group management, event routing, and command dispatch so you can focus on bot logic.
